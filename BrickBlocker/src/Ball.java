...
public class Ball extends Rectangle {
     ...
     * parameters below.
     * The ball will be at least 75 pixels from the edge of this rectangle. (errr...
     * only if maxX and maxY
     * are > 150)
     * 
    ...
    Ball(int maxX, int maxY) {
        ...
        // uncomment the following line if you want each ball to have a different random
        // colour
